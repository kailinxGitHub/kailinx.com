    ...
    >
      ...
      >
        <h6 className="text-2xl font-bold text-primary mb-4 dark:text-white">
          <a
            href="https://ece.northeastern.edu/groups/nucar/"
            target="_blank"
            className="hover:text-cyan-500"
          >
            northeastern university college of engineering ece department
          </a>
          <span className="mt-4 text-xs flex items-center justify-start lowercase text-neutral-600 dark:text-neutral-300">
            <CalendarIcon className="h-4 mr-2 text-neutral-600 dark:text-neutral-300" />
            may, 2024 - present
          </span>
          <span className="mt-2 text-xs flex items-center justify-start lowercase text-neutral-600 dark:text-neutral-300">
        ...
        <ul className="text-base text-primary-400 list-inside list-disc dark:text-neutral-200">
          <li>
            researching the application in parallel computing to sorting algorithms and matrix operations with C/C++.
          </li>
        </ul>
      </motion.div>
